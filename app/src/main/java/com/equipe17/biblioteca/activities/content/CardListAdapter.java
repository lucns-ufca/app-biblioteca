...
public class CardListAdapter extends ArrayAdapter<String> {
    ...
    public CardListAdapter(Context context, Book[] books) {
        super(context, 0);
        this.books = books;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (views[position] == null) {
            if (position == 0) {
                views[position] = inflater.inflate(R.layout.item_list_initial_page_gradient_space, null, false);
            } else {
                View view = inflater.inflate(R.layout.list_item_initial_page, null, false);
